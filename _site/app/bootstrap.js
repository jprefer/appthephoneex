...
(function(window) {
    require.config({
        ...
        paths: {
            ...
            "enterComment_service": "services/enterComment_service",
            "get_CCOF_fromDataBase_service": "services/get_CCOF_fromDataBase_service",
            "SquarePayment_usingAPIExpress_service": "services/SquarePayment_usingAPIExpress_service",
            ...
            '$Register_clone_1': 'pages/Register_clone_1',
