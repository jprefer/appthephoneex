/**
 * Module initializes rest service update_Profile_State_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'update_Profile_State_service',
        deps: ['Apperyio', 'REST', update_Profile_State_serviceImpl]
    }];
    /**
     * @function update_Profile_State_serviceImpl
     */
    function update_Profile_State_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/bb39c1a7-dce1-4f15-a075-e4c4a0406bd1/exec",
            method: "post",
            headers: Apperyio.EntityAPI("update_Profile_State_service.request.headers"),
            params: Apperyio.EntityAPI("update_Profile_State_service.request.query"),
            data: Apperyio.EntityAPI("update_Profile_State_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "update_Profile_State_service"
            }
        };
