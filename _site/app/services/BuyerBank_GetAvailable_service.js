/**
 * Module initializes rest service BuyerBank_GetAvailable_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'BuyerBank_GetAvailable_service',
        deps: ['Apperyio', 'REST', BuyerBank_GetAvailable_serviceImpl]
    }];
    /**
     * @function BuyerBank_GetAvailable_serviceImpl
     */
    function BuyerBank_GetAvailable_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/48f78e51-0b12-401a-8d85-f6b36ee49059/exec",
            method: "post",
            headers: Apperyio.EntityAPI("BuyerBank_GetAvailable_service.request.headers"),
            params: Apperyio.EntityAPI("BuyerBank_GetAvailable_service.request.query"),
            data: Apperyio.EntityAPI("BuyerBank_GetAvailable_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "BuyerBank_GetAvailable_service"
            }
        };
