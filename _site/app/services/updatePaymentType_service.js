/**
 * Module initializes rest service updatePaymentType_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'updatePaymentType_service',
        deps: ['Apperyio', 'REST', updatePaymentType_serviceImpl]
    }];
    /**
     * @function updatePaymentType_serviceImpl
     */
    function updatePaymentType_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/28cfbd6d-6747-4bb3-b890-8eae4e27aa8c/exec",
            method: "post",
            headers: Apperyio.EntityAPI("updatePaymentType_service.request.headers"),
            params: Apperyio.EntityAPI("updatePaymentType_service.request.query"),
            data: Apperyio.EntityAPI("updatePaymentType_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "updatePaymentType_service"
            }
        };
