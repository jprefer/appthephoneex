/**
 * Module initializes rest service Buyer_InProcess_Detail_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'Buyer_InProcess_Detail_service',
        deps: ['Apperyio', 'REST', Buyer_InProcess_Detail_serviceImpl]
    }];
    /**
     * @function Buyer_InProcess_Detail_serviceImpl
     */
    function Buyer_InProcess_Detail_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/4b9c7057-e42a-44ed-a45e-166c91d04743/exec",
            method: "post",
            headers: Apperyio.EntityAPI("Buyer_InProcess_Detail_service.request.headers"),
            params: Apperyio.EntityAPI("Buyer_InProcess_Detail_service.request.query"),
            data: Apperyio.EntityAPI("Buyer_InProcess_Detail_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "Buyer_InProcess_Detail_service"
            }
        };
