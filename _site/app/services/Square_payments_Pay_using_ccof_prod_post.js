/**
 * Module initializes rest service Square_payments_Pay_using_ccof_prod_post
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'Square_payments_Pay_using_ccof_prod_post',
        deps: ['Apperyio', 'REST', Square_payments_Pay_using_ccof_prod_postImpl]
    }];
    /**
     * @function Square_payments_Pay_using_ccof_prod_postImpl
     */
    function Square_payments_Pay_using_ccof_prod_postImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/apiexpress/api/payments/Pay_using_ccof_prod",
            method: "post",
            headers: Apperyio.EntityAPI("Square_payments_Pay_using_ccof_prod_post.request.headers"),
            params: Apperyio.EntityAPI("Square_payments_Pay_using_ccof_prod_post.request.query"),
            data: Apperyio.EntityAPI("Square_payments_Pay_using_ccof_prod_post.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "json",
                responseType: "json",
                serviceName: "Square_payments_Pay_using_ccof_prod_post"
            }
        };
