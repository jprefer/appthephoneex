/**
 * Module initializes rest service update_Profile_Company_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'update_Profile_Company_service',
        deps: ['Apperyio', 'REST', update_Profile_Company_serviceImpl]
    }];
    /**
     * @function update_Profile_Company_serviceImpl
     */
    function update_Profile_Company_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/ce592ade-eedf-4f00-986e-0e9b6ae1fa18/exec",
            method: "post",
            headers: Apperyio.EntityAPI("update_Profile_Company_service.request.headers"),
            params: Apperyio.EntityAPI("update_Profile_Company_service.request.query"),
            data: Apperyio.EntityAPI("update_Profile_Company_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "update_Profile_Company_service"
            }
        };
