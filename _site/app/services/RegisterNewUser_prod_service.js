/**
 * Module initializes rest service RegisterNewUser_prod_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'RegisterNewUser_prod_service',
        deps: ['Apperyio', 'REST', RegisterNewUser_prod_serviceImpl]
    }];
    /**
     * @function RegisterNewUser_prod_serviceImpl
     */
    function RegisterNewUser_prod_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/0668aed3-f620-4ac4-bda6-ed9d36238ee9/exec",
            method: "post",
            headers: Apperyio.EntityAPI("RegisterNewUser_prod_service.request.headers"),
            params: Apperyio.EntityAPI("RegisterNewUser_prod_service.request.query"),
            data: Apperyio.EntityAPI("RegisterNewUser_prod_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "RegisterNewUser_prod_service"
            }
        };
