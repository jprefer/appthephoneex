/**
 * Module initializes rest service Buyer_Complete_Order_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'Buyer_Complete_Order_service',
        deps: ['Apperyio', 'REST', Buyer_Complete_Order_serviceImpl]
    }];
    /**
     * @function Buyer_Complete_Order_serviceImpl
     */
    function Buyer_Complete_Order_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/9e19cac5-22b3-4d11-8679-8ff5bddd0320/exec",
            method: "post",
            headers: Apperyio.EntityAPI("Buyer_Complete_Order_service.request.headers"),
            params: Apperyio.EntityAPI("Buyer_Complete_Order_service.request.query"),
            data: Apperyio.EntityAPI("Buyer_Complete_Order_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "Buyer_Complete_Order_service"
            }
        };
