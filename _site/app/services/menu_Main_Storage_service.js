/**
 * Module initializes rest service menu_Main_Storage_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'menu_Main_Storage_service',
        deps: ['Apperyio', 'REST', menu_Main_Storage_serviceImpl]
    }];
    /**
     * @function menu_Main_Storage_serviceImpl
     */
    function menu_Main_Storage_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/5a6ee864-73f4-4d77-8262-dd9462eff0ff/exec",
            method: "post",
            headers: Apperyio.EntityAPI("menu_Main_Storage_service.request.headers"),
            params: Apperyio.EntityAPI("menu_Main_Storage_service.request.query"),
            data: Apperyio.EntityAPI("menu_Main_Storage_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "menu_Main_Storage_service"
            }
        };
