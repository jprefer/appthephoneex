/**
 * Module initializes rest service PizzaDatabase_Menu_list_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'PizzaDatabase_Menu_list_service',
        deps: ['Apperyio', 'REST', PizzaDatabase_Menu_list_serviceImpl]
    }];
    /**
     * @function PizzaDatabase_Menu_list_serviceImpl
     */
    function PizzaDatabase_Menu_list_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/db/collections/Menu",
            method: "get",
            headers: Apperyio.EntityAPI("PizzaDatabase_Menu_list_service.request.headers"),
            params: Apperyio.EntityAPI("PizzaDatabase_Menu_list_service.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "PizzaDatabase_Menu_list_service"
            }
        };
