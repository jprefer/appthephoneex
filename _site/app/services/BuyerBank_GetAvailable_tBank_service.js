/**
 * Module initializes rest service BuyerBank_GetAvailable_tBank_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'BuyerBank_GetAvailable_tBank_service',
        deps: ['Apperyio', 'REST', BuyerBank_GetAvailable_tBank_serviceImpl]
    }];
    /**
     * @function BuyerBank_GetAvailable_tBank_serviceImpl
     */
    function BuyerBank_GetAvailable_tBank_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/cd2e9e2e-cc2b-40ba-a6b6-728b95c0c593/exec",
            method: "post",
            headers: Apperyio.EntityAPI("BuyerBank_GetAvailable_tBank_service.request.headers"),
            params: Apperyio.EntityAPI("BuyerBank_GetAvailable_tBank_service.request.query"),
            data: Apperyio.EntityAPI("BuyerBank_GetAvailable_tBank_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "BuyerBank_GetAvailable_tBank_service"
            }
        };
