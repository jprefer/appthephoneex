/**
 * Module initializes rest service RegisterNewUser_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'RegisterNewUser_service',
        deps: ['Apperyio', 'REST', RegisterNewUser_serviceImpl]
    }];
    /**
     * @function RegisterNewUser_serviceImpl
     */
    function RegisterNewUser_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/81fffd25-0907-4729-be39-80e1ad7d3a26/exec",
            method: "post",
            headers: Apperyio.EntityAPI("RegisterNewUser_service.request.headers"),
            params: Apperyio.EntityAPI("RegisterNewUser_service.request.query"),
            data: Apperyio.EntityAPI("RegisterNewUser_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "RegisterNewUser_service"
            }
        };
