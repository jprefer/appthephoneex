/**
 * Module initializes rest service update_Profile_ShippingAddress1_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'update_Profile_ShippingAddress1_service',
        deps: ['Apperyio', 'REST', update_Profile_ShippingAddress1_serviceImpl]
    }];
    /**
     * @function update_Profile_ShippingAddress1_serviceImpl
     */
    function update_Profile_ShippingAddress1_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/3864e47a-8c32-4dbd-b5a7-29aabef79895/exec",
            method: "post",
            headers: Apperyio.EntityAPI("update_Profile_ShippingAddress1_service.request.headers"),
            params: Apperyio.EntityAPI("update_Profile_ShippingAddress1_service.request.query"),
            data: Apperyio.EntityAPI("update_Profile_ShippingAddress1_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "update_Profile_ShippingAddress1_service"
            }
        };
