/**
 * Module initializes rest service Buyer_Complete_Return_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'Buyer_Complete_Return_service',
        deps: ['Apperyio', 'REST', Buyer_Complete_Return_serviceImpl]
    }];
    /**
     * @function Buyer_Complete_Return_serviceImpl
     */
    function Buyer_Complete_Return_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/54ef87c8-0ce7-44ba-b33a-1d4842978747/exec",
            method: "post",
            headers: Apperyio.EntityAPI("Buyer_Complete_Return_service.request.headers"),
            params: Apperyio.EntityAPI("Buyer_Complete_Return_service.request.query"),
            data: Apperyio.EntityAPI("Buyer_Complete_Return_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "Buyer_Complete_Return_service"
            }
        };
