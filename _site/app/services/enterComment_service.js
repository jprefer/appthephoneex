/**
 * Module initializes rest service enterComment_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'enterComment_service',
        deps: ['Apperyio', 'REST', enterComment_serviceImpl]
    }];
    /**
     * @function enterComment_serviceImpl
     */
    function enterComment_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/16f35b90-e18e-4f91-995d-37431293b5dd/exec",
            method: "post",
            headers: Apperyio.EntityAPI("enterComment_service.request.headers"),
            params: Apperyio.EntityAPI("enterComment_service.request.query"),
            data: Apperyio.EntityAPI("enterComment_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "enterComment_service"
            }
        };
