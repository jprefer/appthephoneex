/**
 * Module initializes rest service update_Profile_City_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'update_Profile_City_service',
        deps: ['Apperyio', 'REST', update_Profile_City_serviceImpl]
    }];
    /**
     * @function update_Profile_City_serviceImpl
     */
    function update_Profile_City_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/6e706ef5-2ab4-4778-b293-71fd2ddb8a92/exec",
            method: "post",
            headers: Apperyio.EntityAPI("update_Profile_City_service.request.headers"),
            params: Apperyio.EntityAPI("update_Profile_City_service.request.query"),
            data: Apperyio.EntityAPI("update_Profile_City_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "update_Profile_City_service"
            }
        };
