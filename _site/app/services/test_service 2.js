/**
 * Module initializes rest service test_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'test_service',
        deps: ['Apperyio', 'REST', test_serviceImpl]
    }];
    /**
     * @function test_serviceImpl
     */
    function test_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/9d21cd14-7b11-49aa-ba21-cbe6b386f78f/exec",
            method: "post",
            headers: Apperyio.EntityAPI("test_service.request.headers"),
            params: Apperyio.EntityAPI("test_service.request.query"),
            data: Apperyio.EntityAPI("test_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
