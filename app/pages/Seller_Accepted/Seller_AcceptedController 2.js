define(['require', 'app'],
    function(require, APP) {
        /**
         * Controller for Seller_Accepted generated by Appery.io
         * @module Seller_Accepted
         */
        APP.controller('Seller_Accepted', ['$scope', 'Apperyio', controller]);
        ...
        function controller($scope, Apperyio) {
            ...
            $scope.init = function() {
                ...
                Apperyio.get("Seller_Orders_NotShipped_service")(requestData).then(
            ...
            $scope.showDetail = function(_id) {
                ...
                Apperyio.navigateTo("Seller_Ship");
            };
        }
    });