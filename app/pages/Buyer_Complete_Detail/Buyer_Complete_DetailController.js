define(['require', 'app'],
    function(require, APP) {
        /**
         * Controller for Buyer_Complete_Detail generated by Appery.io
         * @module Buyer_Complete_Detail
         */
        APP.controller('Buyer_Complete_Detail', ['$scope', 'Apperyio', controller]);
        ...
        function controller($scope, Apperyio) {
            ...
            $scope.init = function() {
                ...
                Apperyio.get("Buyer_Complete_Detail_service")(requestData).then(
                    ...
                    function(success) { // success callback
                        (function mapping1982(success, $scope) {
                            ...
                            var BuyingPrice1_scope = $scope.BuyingPrice1;
