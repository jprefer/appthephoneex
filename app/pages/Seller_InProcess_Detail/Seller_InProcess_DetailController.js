define(['require', 'app'],
    function(require, APP) {
        /**
         * Controller for Seller_InProcess_Detail generated by Appery.io
         * @module Seller_InProcess_Detail
         */
        APP.controller('Seller_InProcess_Detail', ['$scope', 'Apperyio', controller]);
        ...
        function controller($scope, Apperyio) {
            ...
            $scope.init = function() {
                ...
                Apperyio.get("Seller_Shipped_Detail_service")(requestData).then(
