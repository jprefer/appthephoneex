/**
 * Module initializes rest service sq_RetrieveCustomer_CCOF_prod_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'sq_RetrieveCustomer_CCOF_prod_service',
        deps: ['Apperyio', 'REST', sq_RetrieveCustomer_CCOF_prod_serviceImpl]
    }];
    /**
     * @function sq_RetrieveCustomer_CCOF_prod_serviceImpl
     */
    function sq_RetrieveCustomer_CCOF_prod_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/e8ddb071-023f-4985-9972-443891fef389/exec",
            method: "post",
            headers: Apperyio.EntityAPI("sq_RetrieveCustomer_CCOF_prod_service.request.headers"),
            params: Apperyio.EntityAPI("sq_RetrieveCustomer_CCOF_prod_service.request.query"),
            data: Apperyio.EntityAPI("sq_RetrieveCustomer_CCOF_prod_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "sq_RetrieveCustomer_CCOF_prod_service"
            }
        };
