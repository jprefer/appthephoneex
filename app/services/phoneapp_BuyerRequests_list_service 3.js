/**
 * Module initializes rest service phoneapp_BuyerRequests_list_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'phoneapp_BuyerRequests_list_service',
        deps: ['Apperyio', 'REST', phoneapp_BuyerRequests_list_serviceImpl]
    }];
    /**
     * @function phoneapp_BuyerRequests_list_serviceImpl
     */
    function phoneapp_BuyerRequests_list_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/db/collections/BuyerRequests",
            method: "get",
            headers: Apperyio.EntityAPI("phoneapp_BuyerRequests_list_service.request.headers"),
            params: Apperyio.EntityAPI("phoneapp_BuyerRequests_list_service.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "phoneapp_BuyerRequests_list_service"
            }
        };
