/**
 * Module initializes rest service twilio_Request_sms_Verify_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'twilio_Request_sms_Verify_service',
        deps: ['Apperyio', 'REST', twilio_Request_sms_Verify_serviceImpl]
    }];
    /**
     * @function twilio_Request_sms_Verify_serviceImpl
     */
    function twilio_Request_sms_Verify_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/b68949f0-cded-4b6c-87e7-a44148b160c3/exec",
            method: "post",
            headers: Apperyio.EntityAPI("twilio_Request_sms_Verify_service.request.headers"),
            params: Apperyio.EntityAPI("twilio_Request_sms_Verify_service.request.query"),
            data: Apperyio.EntityAPI("twilio_Request_sms_Verify_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "twilio_Request_sms_Verify_service"
            }
        };
