/**
 * Module initializes rest service Update_TextVer_True_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'Update_TextVer_True_service',
        deps: ['Apperyio', 'REST', Update_TextVer_True_serviceImpl]
    }];
    /**
     * @function Update_TextVer_True_serviceImpl
     */
    function Update_TextVer_True_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/561803c1-4a5c-4597-af47-eae736795d9b/exec",
            method: "post",
            headers: Apperyio.EntityAPI("Update_TextVer_True_service.request.headers"),
            params: Apperyio.EntityAPI("Update_TextVer_True_service.request.query"),
            data: Apperyio.EntityAPI("Update_TextVer_True_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "Update_TextVer_True_service"
            }
        };
