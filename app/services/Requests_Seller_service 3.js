/**
 * Module initializes rest service Requests_Seller_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'Requests_Seller_service',
        deps: ['Apperyio', 'REST', Requests_Seller_serviceImpl]
    }];
    /**
     * @function Requests_Seller_serviceImpl
     */
    function Requests_Seller_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/59327c8a-7b75-46b6-8ded-3143a423457f/exec",
            method: "post",
            headers: Apperyio.EntityAPI("Requests_Seller_service.request.headers"),
            params: Apperyio.EntityAPI("Requests_Seller_service.request.query"),
            data: Apperyio.EntityAPI("Requests_Seller_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "Requests_Seller_service"
            }
        };
