/**
 * Module initializes rest service Buyer_Complete_Detail_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'Buyer_Complete_Detail_service',
        deps: ['Apperyio', 'REST', Buyer_Complete_Detail_serviceImpl]
    }];
    /**
     * @function Buyer_Complete_Detail_serviceImpl
     */
    function Buyer_Complete_Detail_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/8100199f-eefb-445e-8842-e624dcfce667/exec",
            method: "post",
            headers: Apperyio.EntityAPI("Buyer_Complete_Detail_service.request.headers"),
            params: Apperyio.EntityAPI("Buyer_Complete_Detail_service.request.query"),
            data: Apperyio.EntityAPI("Buyer_Complete_Detail_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "Buyer_Complete_Detail_service"
            }
        };
