/**
 * Module initializes rest service ReturnOffersToSeller_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'ReturnOffersToSeller_service',
        deps: ['Apperyio', 'REST', ReturnOffersToSeller_serviceImpl]
    }];
    /**
     * @function ReturnOffersToSeller_serviceImpl
     */
    function ReturnOffersToSeller_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/57b89f0f-b5f4-4e36-9e02-3bf92fc5200e/exec",
            method: "post",
            headers: Apperyio.EntityAPI("ReturnOffersToSeller_service.request.headers"),
            params: Apperyio.EntityAPI("ReturnOffersToSeller_service.request.query"),
            data: Apperyio.EntityAPI("ReturnOffersToSeller_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "ReturnOffersToSeller_service"
            }
        };
