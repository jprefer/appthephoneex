/**
 * Module initializes rest service GetEscrowTranactions_user_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'GetEscrowTranactions_user_service',
        deps: ['Apperyio', 'REST', GetEscrowTranactions_user_serviceImpl]
    }];
    /**
     * @function GetEscrowTranactions_user_serviceImpl
     */
    function GetEscrowTranactions_user_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/dcc1a14d-630c-4164-80c3-bd2b2a03be88/exec",
            method: "post",
            headers: Apperyio.EntityAPI("GetEscrowTranactions_user_service.request.headers"),
            params: Apperyio.EntityAPI("GetEscrowTranactions_user_service.request.query"),
            data: Apperyio.EntityAPI("GetEscrowTranactions_user_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "GetEscrowTranactions_user_service"
            }
        };
