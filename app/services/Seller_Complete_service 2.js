/**
 * Module initializes rest service Seller_Complete_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'Seller_Complete_service',
        deps: ['Apperyio', 'REST', Seller_Complete_serviceImpl]
    }];
    /**
     * @function Seller_Complete_serviceImpl
     */
    function Seller_Complete_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/911d471c-630f-48ca-874b-ddb1955a850d/exec",
            method: "post",
            headers: Apperyio.EntityAPI("Seller_Complete_service.request.headers"),
            params: Apperyio.EntityAPI("Seller_Complete_service.request.query"),
            data: Apperyio.EntityAPI("Seller_Complete_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "Seller_Complete_service"
            }
        };
