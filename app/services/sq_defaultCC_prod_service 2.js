/**
 * Module initializes rest service sq_defaultCC_prod_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'sq_defaultCC_prod_service',
        deps: ['Apperyio', 'REST', sq_defaultCC_prod_serviceImpl]
    }];
    /**
     * @function sq_defaultCC_prod_serviceImpl
     */
    function sq_defaultCC_prod_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/8db4bdbc-cb2e-440a-9f07-5bdee3ea6d8e/exec",
            method: "post",
            headers: Apperyio.EntityAPI("sq_defaultCC_prod_service.request.headers"),
            params: Apperyio.EntityAPI("sq_defaultCC_prod_service.request.query"),
            data: Apperyio.EntityAPI("sq_defaultCC_prod_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "sq_defaultCC_prod_service"
            }
        };
