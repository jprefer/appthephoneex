/**
 * Module initializes rest service sq_defaultCC_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'sq_defaultCC_service',
        deps: ['Apperyio', 'REST', sq_defaultCC_serviceImpl]
    }];
    /**
     * @function sq_defaultCC_serviceImpl
     */
    function sq_defaultCC_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/0fff38e6-c55a-4d7e-9053-e66dca61927c/exec",
            method: "post",
            headers: Apperyio.EntityAPI("sq_defaultCC_service.request.headers"),
            params: Apperyio.EntityAPI("sq_defaultCC_service.request.query"),
            data: Apperyio.EntityAPI("sq_defaultCC_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "sq_defaultCC_service"
            }
        };
