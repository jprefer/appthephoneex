/**
 * Module initializes rest service Insert_User_Device_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'Insert_User_Device_service',
        deps: ['Apperyio', 'REST', Insert_User_Device_serviceImpl]
    }];
    /**
     * @function Insert_User_Device_serviceImpl
     */
    function Insert_User_Device_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/6bcd2584-15b6-49e6-b6fb-eccbfa8edae9/exec",
            method: "post",
            headers: Apperyio.EntityAPI("Insert_User_Device_service.request.headers"),
            params: Apperyio.EntityAPI("Insert_User_Device_service.request.query"),
            data: Apperyio.EntityAPI("Insert_User_Device_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "Insert_User_Device_service"
            }
        };
