/**
 * Module initializes rest service Get_user_id_profileId_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'Get_user_id_profileId_service',
        deps: ['Apperyio', 'REST', Get_user_id_profileId_serviceImpl]
    }];
    /**
     * @function Get_user_id_profileId_serviceImpl
     */
    function Get_user_id_profileId_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/d63c9ecf-cc8d-41c1-ad25-73bf1ddc8e13/exec",
            method: "post",
            headers: Apperyio.EntityAPI("Get_user_id_profileId_service.request.headers"),
            params: Apperyio.EntityAPI("Get_user_id_profileId_service.request.query"),
            data: Apperyio.EntityAPI("Get_user_id_profileId_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "Get_user_id_profileId_service"
            }
        };
