/**
 * Module initializes rest service Buyer_Complete_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'Buyer_Complete_service',
        deps: ['Apperyio', 'REST', Buyer_Complete_serviceImpl]
    }];
    /**
     * @function Buyer_Complete_serviceImpl
     */
    function Buyer_Complete_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/882fb49f-fb03-403e-a766-1b9876df23fb/exec",
            method: "post",
            headers: Apperyio.EntityAPI("Buyer_Complete_service.request.headers"),
            params: Apperyio.EntityAPI("Buyer_Complete_service.request.query"),
            data: Apperyio.EntityAPI("Buyer_Complete_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "Buyer_Complete_service"
            }
        };
