/**
 * Module initializes rest service getMenu4_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'getMenu4_service',
        deps: ['Apperyio', 'REST', getMenu4_serviceImpl]
    }];
    /**
     * @function getMenu4_serviceImpl
     */
    function getMenu4_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/336fd32b-c515-4324-a732-74d05208dfc3/exec",
            method: "post",
            headers: Apperyio.EntityAPI("getMenu4_service.request.headers"),
            params: Apperyio.EntityAPI("getMenu4_service.request.query"),
            data: Apperyio.EntityAPI("getMenu4_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "getMenu4_service"
            }
        };
