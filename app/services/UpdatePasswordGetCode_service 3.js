/**
 * Module initializes rest service UpdatePasswordGetCode_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'UpdatePasswordGetCode_service',
        deps: ['Apperyio', 'REST', UpdatePasswordGetCode_serviceImpl]
    }];
    /**
     * @function UpdatePasswordGetCode_serviceImpl
     */
    function UpdatePasswordGetCode_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/5a8d1687-9b6a-4727-8ea6-e0d7a3e58bf6/exec",
            method: "post",
            headers: Apperyio.EntityAPI("UpdatePasswordGetCode_service.request.headers"),
            params: Apperyio.EntityAPI("UpdatePasswordGetCode_service.request.query"),
            data: Apperyio.EntityAPI("UpdatePasswordGetCode_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "UpdatePasswordGetCode_service"
            }
        };
