/**
 * Module initializes rest service SendEmailforEscrow_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'SendEmailforEscrow_service',
        deps: ['Apperyio', 'REST', SendEmailforEscrow_serviceImpl]
    }];
    /**
     * @function SendEmailforEscrow_serviceImpl
     */
    function SendEmailforEscrow_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/b718ee58-002b-4573-8f0a-6be4bc36a055/exec",
            method: "post",
            headers: Apperyio.EntityAPI("SendEmailforEscrow_service.request.headers"),
            params: Apperyio.EntityAPI("SendEmailforEscrow_service.request.query"),
            data: Apperyio.EntityAPI("SendEmailforEscrow_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "SendEmailforEscrow_service"
            }
        };
