/**
 * Module initializes rest service menu_Main_Model_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'menu_Main_Model_service',
        deps: ['Apperyio', 'REST', menu_Main_Model_serviceImpl]
    }];
    /**
     * @function menu_Main_Model_serviceImpl
     */
    function menu_Main_Model_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/59b028cf-1059-4b2b-98a1-bb44fdb90bc0/exec",
            method: "post",
            headers: Apperyio.EntityAPI("menu_Main_Model_service.request.headers"),
            params: Apperyio.EntityAPI("menu_Main_Model_service.request.query"),
            data: Apperyio.EntityAPI("menu_Main_Model_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "menu_Main_Model_service"
            }
        };
