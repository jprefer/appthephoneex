/**
 * Module initializes rest service InsertOrders_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'InsertOrders_service',
        deps: ['Apperyio', 'REST', InsertOrders_serviceImpl]
    }];
    /**
     * @function InsertOrders_serviceImpl
     */
    function InsertOrders_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/bffa6619-4d43-4a87-b810-9ae46be4258f/exec",
            method: "post",
            headers: Apperyio.EntityAPI("InsertOrders_service.request.headers"),
            params: Apperyio.EntityAPI("InsertOrders_service.request.query"),
            data: Apperyio.EntityAPI("InsertOrders_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "InsertOrders_service"
            }
        };
