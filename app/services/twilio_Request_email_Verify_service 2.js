/**
 * Module initializes rest service twilio_Request_email_Verify_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'twilio_Request_email_Verify_service',
        deps: ['Apperyio', 'REST', twilio_Request_email_Verify_serviceImpl]
    }];
    /**
     * @function twilio_Request_email_Verify_serviceImpl
     */
    function twilio_Request_email_Verify_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/ed8c3615-22d7-4421-be15-726d844ddeee/exec",
            method: "post",
            headers: Apperyio.EntityAPI("twilio_Request_email_Verify_service.request.headers"),
            params: Apperyio.EntityAPI("twilio_Request_email_Verify_service.request.query"),
            data: Apperyio.EntityAPI("twilio_Request_email_Verify_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "twilio_Request_email_Verify_service"
            }
        };
