/**
 * Module initializes rest service Update_EmailVer_True_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'Update_EmailVer_True_service',
        deps: ['Apperyio', 'REST', Update_EmailVer_True_serviceImpl]
    }];
    /**
     * @function Update_EmailVer_True_serviceImpl
     */
    function Update_EmailVer_True_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/7b724054-5ed9-4903-a399-85d5a8d6a83e/exec",
            method: "post",
            headers: Apperyio.EntityAPI("Update_EmailVer_True_service.request.headers"),
            params: Apperyio.EntityAPI("Update_EmailVer_True_service.request.query"),
            data: Apperyio.EntityAPI("Update_EmailVer_True_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "Update_EmailVer_True_service"
            }
        };
