/**
 * Module initializes rest service getMenu2_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'getMenu2_service',
        deps: ['Apperyio', 'REST', getMenu2_serviceImpl]
    }];
    /**
     * @function getMenu2_serviceImpl
     */
    function getMenu2_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/9f568528-9a5b-4918-81e8-f3f1227cad23/exec",
            method: "post",
            headers: Apperyio.EntityAPI("getMenu2_service.request.headers"),
            params: Apperyio.EntityAPI("getMenu2_service.request.query"),
            data: Apperyio.EntityAPI("getMenu2_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "getMenu2_service"
            }
        };
