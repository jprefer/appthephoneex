/**
 * Module initializes rest service phoneapp_BuyerRequests_update_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'phoneapp_BuyerRequests_update_service',
        deps: ['Apperyio', 'REST', phoneapp_BuyerRequests_update_serviceImpl]
    }];
    /**
     * @function phoneapp_BuyerRequests_update_serviceImpl
     */
    function phoneapp_BuyerRequests_update_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/db/collections/BuyerRequests/{_id}",
            method: "put",
            headers: Apperyio.EntityAPI("phoneapp_BuyerRequests_update_service.request.headers"),
            params: Apperyio.EntityAPI("phoneapp_BuyerRequests_update_service.request.query"),
            data: Apperyio.EntityAPI("phoneapp_BuyerRequests_update_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "json",
                responseType: "json",
                serviceName: "phoneapp_BuyerRequests_update_service"
            }
        };
