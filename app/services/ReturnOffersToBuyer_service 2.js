/**
 * Module initializes rest service ReturnOffersToBuyer_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'ReturnOffersToBuyer_service',
        deps: ['Apperyio', 'REST', ReturnOffersToBuyer_serviceImpl]
    }];
    /**
     * @function ReturnOffersToBuyer_serviceImpl
     */
    function ReturnOffersToBuyer_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/a064b3ad-fd41-4f70-bacd-2ce3260dd20a/exec",
            method: "post",
            headers: Apperyio.EntityAPI("ReturnOffersToBuyer_service.request.headers"),
            params: Apperyio.EntityAPI("ReturnOffersToBuyer_service.request.query"),
            data: Apperyio.EntityAPI("ReturnOffersToBuyer_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "ReturnOffersToBuyer_service"
            }
        };
