/**
 * Module initializes rest service Update_UserPassword_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'Update_UserPassword_service',
        deps: ['Apperyio', 'REST', Update_UserPassword_serviceImpl]
    }];
    /**
     * @function Update_UserPassword_serviceImpl
     */
    function Update_UserPassword_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/3c1442f5-be1d-4610-806b-d7627859a913/exec",
            method: "post",
            headers: Apperyio.EntityAPI("Update_UserPassword_service.request.headers"),
            params: Apperyio.EntityAPI("Update_UserPassword_service.request.query"),
            data: Apperyio.EntityAPI("Update_UserPassword_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "Update_UserPassword_service"
            }
        };
