/**
 * Module initializes rest service InsertRequest_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'InsertRequest_service',
        deps: ['Apperyio', 'REST', InsertRequest_serviceImpl]
    }];
    /**
     * @function InsertRequest_serviceImpl
     */
    function InsertRequest_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/3464dbc7-29d3-446d-a786-a11176f6a4de/exec",
            method: "post",
            headers: Apperyio.EntityAPI("InsertRequest_service.request.headers"),
            params: Apperyio.EntityAPI("InsertRequest_service.request.query"),
            data: Apperyio.EntityAPI("InsertRequest_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "InsertRequest_service"
            }
        };
