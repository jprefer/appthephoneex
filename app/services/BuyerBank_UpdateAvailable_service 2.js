/**
 * Module initializes rest service BuyerBank_UpdateAvailable_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'BuyerBank_UpdateAvailable_service',
        deps: ['Apperyio', 'REST', BuyerBank_UpdateAvailable_serviceImpl]
    }];
    /**
     * @function BuyerBank_UpdateAvailable_serviceImpl
     */
    function BuyerBank_UpdateAvailable_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/b3e4d9e2-b33e-42a1-8567-75a519e52334/exec",
            method: "post",
            headers: Apperyio.EntityAPI("BuyerBank_UpdateAvailable_service.request.headers"),
            params: Apperyio.EntityAPI("BuyerBank_UpdateAvailable_service.request.query"),
            data: Apperyio.EntityAPI("BuyerBank_UpdateAvailable_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "BuyerBank_UpdateAvailable_service"
            }
        };
