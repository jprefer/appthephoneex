/**
 * Module initializes rest service Seller_Shipped_Detail_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'Seller_Shipped_Detail_service',
        deps: ['Apperyio', 'REST', Seller_Shipped_Detail_serviceImpl]
    }];
    /**
     * @function Seller_Shipped_Detail_serviceImpl
     */
    function Seller_Shipped_Detail_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/ed9a3868-c9c4-46eb-8c41-16949cd3a724/exec",
            method: "post",
            headers: Apperyio.EntityAPI("Seller_Shipped_Detail_service.request.headers"),
            params: Apperyio.EntityAPI("Seller_Shipped_Detail_service.request.query"),
            data: Apperyio.EntityAPI("Seller_Shipped_Detail_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "Seller_Shipped_Detail_service"
            }
        };
