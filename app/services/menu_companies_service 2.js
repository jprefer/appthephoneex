/**
 * Module initializes rest service menu_companies_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'menu_companies_service',
        deps: ['Apperyio', 'REST', menu_companies_serviceImpl]
    }];
    /**
     * @function menu_companies_serviceImpl
     */
    function menu_companies_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/5ff21764-8a1b-4b03-885b-b366a4fe9b23/exec",
            method: "post",
            headers: Apperyio.EntityAPI("menu_companies_service.request.headers"),
            params: Apperyio.EntityAPI("menu_companies_service.request.query"),
            data: Apperyio.EntityAPI("menu_companies_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "menu_companies_service"
            }
        };
