/**
 * Module initializes rest service ReturnRequests_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'ReturnRequests_service',
        deps: ['Apperyio', 'REST', ReturnRequests_serviceImpl]
    }];
    /**
     * @function ReturnRequests_serviceImpl
     */
    function ReturnRequests_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/ca617f6e-8830-403e-8f61-333aa3a97812/exec",
            method: "post",
            headers: Apperyio.EntityAPI("ReturnRequests_service.request.headers"),
            params: Apperyio.EntityAPI("ReturnRequests_service.request.query"),
            data: Apperyio.EntityAPI("ReturnRequests_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "ReturnRequests_service"
            }
        };
