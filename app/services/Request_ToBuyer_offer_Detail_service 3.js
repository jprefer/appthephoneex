/**
 * Module initializes rest service Request_ToBuyer_offer_Detail_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'Request_ToBuyer_offer_Detail_service',
        deps: ['Apperyio', 'REST', Request_ToBuyer_offer_Detail_serviceImpl]
    }];
    /**
     * @function Request_ToBuyer_offer_Detail_serviceImpl
     */
    function Request_ToBuyer_offer_Detail_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/b1891604-14cb-4003-95d8-302b7c62d88e/exec",
            method: "post",
            headers: Apperyio.EntityAPI("Request_ToBuyer_offer_Detail_service.request.headers"),
            params: Apperyio.EntityAPI("Request_ToBuyer_offer_Detail_service.request.query"),
            data: Apperyio.EntityAPI("Request_ToBuyer_offer_Detail_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "Request_ToBuyer_offer_Detail_service"
            }
        };
