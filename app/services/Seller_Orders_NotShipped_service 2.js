/**
 * Module initializes rest service Seller_Orders_NotShipped_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'Seller_Orders_NotShipped_service',
        deps: ['Apperyio', 'REST', Seller_Orders_NotShipped_serviceImpl]
    }];
    /**
     * @function Seller_Orders_NotShipped_serviceImpl
     */
    function Seller_Orders_NotShipped_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/5146bafc-160e-4411-bb43-e62fb1f36456/exec",
            method: "post",
            headers: Apperyio.EntityAPI("Seller_Orders_NotShipped_service.request.headers"),
            params: Apperyio.EntityAPI("Seller_Orders_NotShipped_service.request.query"),
            data: Apperyio.EntityAPI("Seller_Orders_NotShipped_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "Seller_Orders_NotShipped_service"
            }
        };
