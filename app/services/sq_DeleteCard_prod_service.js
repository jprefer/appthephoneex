/**
 * Module initializes rest service sq_DeleteCard_prod_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'sq_DeleteCard_prod_service',
        deps: ['Apperyio', 'REST', sq_DeleteCard_prod_serviceImpl]
    }];
    /**
     * @function sq_DeleteCard_prod_serviceImpl
     */
    function sq_DeleteCard_prod_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
        ...
        this.config = {
            ...
            method: "post",
            headers: Apperyio.EntityAPI("sq_DeleteCard_prod_service.request.headers"),
            params: Apperyio.EntityAPI("sq_DeleteCard_prod_service.request.query"),
            data: Apperyio.EntityAPI("sq_DeleteCard_prod_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "sq_DeleteCard_prod_service"
            }
        };
