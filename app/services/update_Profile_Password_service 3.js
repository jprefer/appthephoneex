/**
 * Module initializes rest service update_Profile_Password_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'update_Profile_Password_service',
        deps: ['Apperyio', 'REST', update_Profile_Password_serviceImpl]
    }];
    /**
     * @function update_Profile_Password_serviceImpl
     */
    function update_Profile_Password_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/20879620-bb9f-4ce0-b4dd-504bad49b273/exec",
            method: "post",
            headers: Apperyio.EntityAPI("update_Profile_Password_service.request.headers"),
            params: Apperyio.EntityAPI("update_Profile_Password_service.request.query"),
            data: Apperyio.EntityAPI("update_Profile_Password_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "update_Profile_Password_service"
            }
        };
