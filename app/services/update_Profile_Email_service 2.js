/**
 * Module initializes rest service update_Profile_Email_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'update_Profile_Email_service',
        deps: ['Apperyio', 'REST', update_Profile_Email_serviceImpl]
    }];
    /**
     * @function update_Profile_Email_serviceImpl
     */
    function update_Profile_Email_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/e5058480-222f-43d6-858f-482961619460/exec",
            method: "post",
            headers: Apperyio.EntityAPI("update_Profile_Email_service.request.headers"),
            params: Apperyio.EntityAPI("update_Profile_Email_service.request.query"),
            data: Apperyio.EntityAPI("update_Profile_Email_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "update_Profile_Email_service"
            }
        };
