/**
 * Module initializes rest service Seller_NotShipped_Detal_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'Seller_NotShipped_Detal_service',
        deps: ['Apperyio', 'REST', Seller_NotShipped_Detal_serviceImpl]
    }];
    /**
     * @function Seller_NotShipped_Detal_serviceImpl
     */
    function Seller_NotShipped_Detal_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/3dc7ab0c-bab7-4dc0-b6a2-7a14b6ab9626/exec",
            method: "post",
            headers: Apperyio.EntityAPI("Seller_NotShipped_Detal_service.request.headers"),
            params: Apperyio.EntityAPI("Seller_NotShipped_Detal_service.request.query"),
            data: Apperyio.EntityAPI("Seller_NotShipped_Detal_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "Seller_NotShipped_Detal_service"
            }
        };
