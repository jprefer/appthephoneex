/**
 * Module initializes rest service get_CCOF_fromDataBase_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'get_CCOF_fromDataBase_service',
        deps: ['Apperyio', 'REST', get_CCOF_fromDataBase_serviceImpl]
    }];
    /**
     * @function get_CCOF_fromDataBase_serviceImpl
     */
    function get_CCOF_fromDataBase_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/f62b4757-504f-4e2f-925e-04b8f2a295fe/exec",
            method: "post",
            headers: Apperyio.EntityAPI("get_CCOF_fromDataBase_service.request.headers"),
            params: Apperyio.EntityAPI("get_CCOF_fromDataBase_service.request.query"),
            data: Apperyio.EntityAPI("get_CCOF_fromDataBase_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "get_CCOF_fromDataBase_service"
            }
        };
