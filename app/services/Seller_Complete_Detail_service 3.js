/**
 * Module initializes rest service Seller_Complete_Detail_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'Seller_Complete_Detail_service',
        deps: ['Apperyio', 'REST', Seller_Complete_Detail_serviceImpl]
    }];
    /**
     * @function Seller_Complete_Detail_serviceImpl
     */
    function Seller_Complete_Detail_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/842c92b3-33e3-4ff6-8393-e3842abdebc7/exec",
            method: "post",
            headers: Apperyio.EntityAPI("Seller_Complete_Detail_service.request.headers"),
            params: Apperyio.EntityAPI("Seller_Complete_Detail_service.request.query"),
            data: Apperyio.EntityAPI("Seller_Complete_Detail_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "Seller_Complete_Detail_service"
            }
        };
