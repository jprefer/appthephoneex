/**
 * Module initializes rest service InsertOffers_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'InsertOffers_service',
        deps: ['Apperyio', 'REST', InsertOffers_serviceImpl]
    }];
    /**
     * @function InsertOffers_serviceImpl
     */
    function InsertOffers_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/code/d7ef26f7-8ec3-4f79-83df-16aba9f7c55c/exec",
            method: "post",
            headers: Apperyio.EntityAPI("InsertOffers_service.request.headers"),
            params: Apperyio.EntityAPI("InsertOffers_service.request.query"),
            data: Apperyio.EntityAPI("InsertOffers_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "InsertOffers_service"
            }
        };
